...
A modern AIS/NMEA decoder built with a focus on data integrity, maintainability, and performance. Features include automated testing, clear decoding logic, improved validation and error handling, strong types via typescript, and a quality-check system for filtering unreliable position reports.
